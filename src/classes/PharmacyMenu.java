...
public class PharmacyMenu extends javax.swing.JFrame {
 ...
 jDP.removeAll();
        jDP.repaint();
        pharmacy_ui frame = new pharmacy_ui();
...
jDP.removeAll();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PharmacyMenu().setVisible(true);
            }
        });
    }
