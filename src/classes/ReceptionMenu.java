...
public class ReceptionMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLP.add(stt);
        stt.setBounds(30, 520, 80, 20);

        rl.setFont(new java.awt.Font("Trebuchet MS", 1, 17)); // NOI18N
        rl.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        rl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/store/r2.png"))); // NOI18N
        ...
        jLP.add(rl);
        rl.setBounds(30, 300, 80, 70);

        rt.setFont(new java.awt.Font("Trebuchet MS", 1, 17)); // NOI18N
        rt.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        rt.setText("Reports");
        jLP.add(rt);
        rt.setBounds(30, 370, 80, 20);

        pl.setFont(new java.awt.Font("Trebuchet MS", 1, 17)); // NOI18N
        pl.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        pl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/store/p2.png"))); // NOI18N
        ...
        jLP.add(pl);
        pl.setBounds(30, 160, 80, 70);

        pt.setFont(new java.awt.Font("Trebuchet MS", 1, 17)); // NOI18N
        pt.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        pt.setText("Students");
        jLP.add(pt);
        pt.setBounds(30, 230, 80, 20);
        ...
        dl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/store/d2.png"))); // NOI18N
 ...
 jDP.removeAll();
        jDP.repaint();
        reception_session frame = new reception_session();
...
jDP.removeAll();
    ...
    private void rlMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rlMouseEntered
       rl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/store/r1.png"))); // NOI18N
        rt.setForeground(new java.awt.Color(52, 152, 219));        // TODO add your handling code here:
        // TODO add your handling code here:
    }//GEN-LAST:event_rlMouseEntered

    private void rlMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rlMouseExited
   rl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/store/r2.png"))); // NOI18N
        rt.setForeground(new java.awt.Color(0, 0, 0));        
// TODO add your handling code here:
...
jDP.removeAll();
        jDP.repaint();
        reception_gene frame = new reception_gene();
        Dimension screenSize = jDP.getSize();
        frame.setSize(screenSize.width, screenSize.height);
        jDP.add(frame);
        int width = frame.getWidth();
    ...
    private void plMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_plMouseEntered
       pl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/store/p1.png"))); // NOI18N
        pt.setForeground(new java.awt.Color(52, 152, 219));        // TODO add your handling code here:
        // TODO add your handling code here:
...
jDP.removeAll();
    ...
    private void dlMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dlMouseEntered
      dl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/store/d1.png"))); // NOI18N
